/* totm-ui-components v1.0.0 */
'use strict';

var v4 = require('@tamagui/config/v4');
var tamagui = require('tamagui');
var jsxRuntime = require('react/jsx-runtime');
var React = require('react');

const config = tamagui.createTamagui({ ...v4.defaultConfig, settings: { onlyAllowShorthands: false, } });
...
const UIProvider = ({ children, defaultTheme = 'light' }) => {
    return jsxRuntime.jsx(tamagui.TamaguiProvider, { config: config, defaultTheme: defaultTheme, children: children });
};
...
const ButtonContext = tamagui.createStyledContext({
    size: '$4',
    variant: 'primary',
});
const ButtonFrame = tamagui.styled(tamagui.View, {
    name: 'Button',
...
const ButtonText = tamagui.styled(tamagui.Text, {
    name: 'ButtonText',
    context: ButtonContext,
    color: '$color',
    fontFamily: '$body',
...
const Button = tamagui.withStaticProperties(ButtonFrame, {
